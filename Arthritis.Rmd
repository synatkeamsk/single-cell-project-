...
ElbowPlot(All_arthritis_normal, ndims = 50,reduction = "pca") +
  ggtitle("Number of principle component")  + theme(plot.title = element_text(hjust = 0.5))
``` 

# Visulization of PC1 and PC2 in heatmap 
``` {r, fig.width= 8, fig.height= 7}
#heatmap of the first principle component
DimHeatmap(All_arthritis_normal, dims = 1:2, cells = 500, balanced = TRUE)
```
...
All_arthritis_integration_TSNE <- FindClusters(All_arthritis_integration_TSNE, resolution = 0.2)
...
DimPlot(All_arthritis_integration_TSNE, reduction = "tsne", label = TRUE) + 
  theme_minimal() +
...
``` {r, fig.width= 4, fig.height= 4}
DimPlot(All_arthritis_integration_TSNE, reduction = "tsne", group.by = "type") +
  theme_minimal() +
